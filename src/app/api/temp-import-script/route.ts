...
export async function GET() {
  ...
  const eventId = "91458b94-24c7-43f7-a734-b90f1b65c78a"; // THE BUILDER SESSION '26

  // 1. Clear old waitlist entries first
...
2026-07-07T06:24:38.589Z	Boadi stephen 	stephenboadi255@gmail.com	+233257510675	Student	All of the above	Very reliable to learn websites 	WhatsApp
...
2026-07-26T12:06:32.443Z	Frank Junior Asare 	frankjuniorasare@gmail.com	596251366	Student	All of the above	I want to build a tech skills which will make me relevant in the coming years and also be able to build real world problem solving mindset through tech	WhatsApp`;
  ...
  return NextResponse.json({ success: true, count: waitlistToInsert.length });
}
