...
function WaitlistPageContent() {
  ...
  return (
    <div className="min-h-screen bg-bg-canvas text-text-primary flex flex-col items-center px-4 sm:px-6 py-12 transition-colors duration-150 relative overflow-x-hidden">
