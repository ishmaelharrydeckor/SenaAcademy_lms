    ...
    return (
      <div className="h-96 flex flex-col items-center justify-center gap-3">
        <div className="relative w-8 h-8 border-2 border-zinc-800 rounded-full">
          <div className="absolute w-8 h-8 border-2 border-t-supporting-purple border-r-primary-blue rounded-full animate-spin"></div>
        </div>
        <p className="text-xs text-zinc-500 uppercase tracking-widest">Loading submissions details...</p>
      </div>
    );
  }
