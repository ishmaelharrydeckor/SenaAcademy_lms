...
async function main() {
  ...
  const teamsLink = 'https://teams.live.com/meet/9345196035980?p=z0vCaepAncnUgR7tox';
  ...
  for (let i = 0; i < paidStudents.length; i++) {
    ...
    const emailSubject = '🔴 Live Now: Module 3 Session (7:00 PM GMT)';
    const emailHtml = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; color: #1e293b;">
        <h2 style="color: #ef4444; margin-top: 0; font-size: 20px; font-weight: 700; border-bottom: 1px solid #ef4444; padding-bottom: 15px;">🔴 Live Now: Module 3 Session</h2>
        <p style="font-size: 15px; line-height: 1.6; color: #334155; margin: 20px 0;">Hi ${student.name},</p>
        <p style="font-size: 15px; line-height: 1.6; color: #334155; margin: 20px 0;">Our live session for **Module 3** of the Founding Builders Cohort is starting right now!</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${teamsLink}" style="background-color: #0f172a; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px; display: inline-block;">Join Module 3 Live Session</a>
        </div>
