...
async function main() {
  ...
  const progressFile = path.join(__dirname, 'tuesday_campaign_progress.json');
  ...
  console.log('=============================================================');
  console.log('       SENA ACADEMY CAMPAIGN: TUESDAY (VALUE TEASER)');
  console.log('=============================================================');
  ...
  for (let i = 0; i < pending.length; i++) {
    ...
    // Tuesday templates
    const emailSubject = 'Founding Builders: What you will ship starting Saturday';
    const emailHtml = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; color: #1e293b;">
        <h2 style="color: #0f172a; margin-top: 0; font-size: 20px; font-weight: 700; border-bottom: 1px solid #e2e8f0; padding-bottom: 15px;">What you will ship starting Saturday</h2>
        <p style="font-size: 15px; line-height: 1.6; color: #334155;">Hi ${firstName},</p>
        <p style="font-size: 15px; line-height: 1.6; color: #334155;">This Saturday at Sena Academy, we are not doing dry lectures or memorization. You are joining to design, build, and ship real projects.</p>
        <p style="font-size: 15px; line-height: 1.6; color: #334155; font-weight: 600;">Here is what you will deploy:</p>
        <ul style="font-size: 14px; color: #334155; line-height: 1.8; padding-left: 20px;">
          <li><strong>Module 1 & 2:</strong> Premium UI prototypes and layouts in Figma.</li>
          <li><strong>Module 3:</strong> Interactive frontends coded and deployed live on Vercel.</li>
          <li><strong>Module 4:</strong> A packageable Android mobile app (React Native & Expo).</li>
          <li><strong>Module 5:</strong> Cloud databases and server-side APIs (FastAPI & Supabase).</li>
          <li><strong>Module 6:</strong> Standalone portfolios and freelancing client acquisition.</li>
        </ul>
        ...
        <p style="font-size: 13px; color: #64748b; font-style: italic;">*Note: The GHS 100 discount expires this Wednesday night at 11:59 PM. Regular price is GHS 200.</p>
        <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 25px 0;" />
        <p style="font-size: 12px; color: #64748b; margin: 0;">— The Sena Academy Team</p>
      </div>
    `;

    const smsText = `Hi ${firstName},\nthis Saturday you start building. You'll code frontends, deploy cloud backends, and build installable Android apps. Secure GHS 100 seat: senaacademy.org/enroll`;
