...
// Optimized 1-segment message (147 characters)
function generateMessage(firstName) {
  return `Hi ${firstName}, we are live now! Join the EN Study Success Series room here: https://teams.live.com/meet/9376187419288?p=Rw61utzVx5i6TGC4cx | Echelon`;
}
...
async function main() {
  ...
  const progressFile = path.join(__dirname, 'echelon_live_progress.json');
  ...
  console.log('=============================================================');
  console.log('              ECHELON "LIVE NOW" REMINDER');
  console.log('=============================================================');
  ...
  if (pending.length === 0) {
    console.log('[Info] All live reminders sent successfully.');
    process.exit(0);
  }

  console.log('Starting campaign live dispatch in 3 seconds...');
