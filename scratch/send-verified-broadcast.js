...
async function sendVerifiedPreview() {
  console.log('Sending full broadcast preview from verified sender: support@senaacademy.org to harrydeckor@gmail.com...\n');
  ...
  try {
    ...
    console.log('✅ Sent via verified sender support@senaacademy.org:', data);
  } catch (err) {
