...
async function main() {
  ...
  const progressFile = path.join(__dirname, 'src_campaign_progress.json');
  ...
  console.log('=============================================================');
  console.log('         SRC CAMPAIGN DISPATCH: FORSTELL & ABDUL SALAM');
  console.log('=============================================================');
  ...
  for (let i = 0; i < totalPending; i += BATCH_SIZE) {
    ...
    if (res.success) {
      ...
      // If balance is too low, abort campaign to let user top up
